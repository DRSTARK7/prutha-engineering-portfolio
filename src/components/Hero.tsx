  ...
  return (
    <section id="hero" className="relative min-h-screen w-full overflow-hidden flex items-center justify-center bg-grid">
      ...
      <div className="container-custom relative z-10 text-center px-4 md:px-0">
        <span className="inline-block py-1 px-3 mb-4 text-xs md:text-sm font-semibold text-blue-700 bg-blue-50 rounded-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a 
            href="#contact" 
            className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-primary text-primary-foreground rounded-md shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 text-base md:text-lg font-medium"
          >
            Get in Touch
          </a>
          <a 
            href="#services" 
            className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 border border-primary/20 rounded-md hover:bg-primary/5 transition-all hover:-translate-y-0.5 text-base md:text-lg font-medium"
          >
